...
% TODO: poly time??? (appendix to the algorithm used...
\subsubsection{Finding the digital root}
Next, we introduce the idea of a digital root.
TODO: introduce. Basically this is the amount you add with every ${T^j}'$.
So, period is ${T^j}' \cdot DigRoot$.

\subsubsection{Finding the period of $s^k$}
