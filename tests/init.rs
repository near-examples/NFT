...
pub async fn init(
    ...
    let token_receiver_wasm =
        near_workspaces::compile_project("./tests/contracts/token-receiver").await?;
    ...
    let approval_receiver_wasm =
        near_workspaces::compile_project("./tests/contracts/approval-receiver").await?;
